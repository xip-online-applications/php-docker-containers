...
COPY --from=ghcr.io/xip-online-applications/php-docker-containers/php-dev-extra-deepclone:8.5 /opt /opt
...
COPY --from=ghcr.io/xip-online-applications/php-docker-containers/php-dev-extra-opentelemetry:8.5 /opt /opt
